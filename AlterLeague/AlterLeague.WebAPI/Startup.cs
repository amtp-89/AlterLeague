...
namespace AlterLeague.WebAPI
{
    public class Startup
    {
        ...
        {
            services.AddTransient<DbContext, AlterLeagueContext>();
            services.AddTransient<IPlayerDAL, PlayerDAL>();
            services.AddTransient<IGameDAL, GameDAL>();
            //services.AddTransient<IPlayer_GameDAL, Player_GameDAL>();
